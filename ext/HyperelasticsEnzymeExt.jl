...
function Hyperelastics._SecondPiolaKirchoffStressTensor(ψ::Hyperelastics.AbstractHyperelasticModel, λ⃗::Vector{T}, p, ad_type::AutoEnzyme; mode=Forward, kwargs...) where {T}
